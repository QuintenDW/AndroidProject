...
class GameDaoTest {
    ...
    private var game = Game(11000,"test game","Dit is een test game","shooter","browser","Quinten DW")
    private var game2 = Game(11001,"test game 2","Dit is een test game","shooter","browser","Quinten DW")
